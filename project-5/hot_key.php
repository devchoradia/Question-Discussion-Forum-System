  ...
  <div class="w3-row w3-padding-64">
    <!-- <div class="w3-twothird w3-container"> -->
      ...
      $category = array("1"=>"Algorithm","2"=>"Machine Learning","3"=>"System","4"=>"Java Script");
        $select_que = mysqli_query($con,"SELECT * FROM question where status='1' ORDER BY up DESC");
      ...
      <h3 class="w3-text-teal" style="text-align: center;"><?php echo $category[$fet_que['space']];?></h3>
          ...
          <div class="column2" >
            <a href="#" id="column5"><h2><?php echo $fet_que['title'];?></h2></a>
            ...
            <p><textarea name="answer" id="answer_<?php echo $fet_que['qid'];?>" style="display: none;" pleaceholder="Type Answer"></textarea></p>
            <a id="saveans_<?php echo $fet_que['qid'];?>" onclick="save('<?php echo $fet_que['qid'];?>')" style="display: none;" style="cursor: pointer;">Submit</a> -->
            <hr>
