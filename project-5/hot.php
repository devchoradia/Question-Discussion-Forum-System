    ...
    <!-- <div class="w3-twothird w3-container"> -->
      ...
      <h3 class="w3-text-teal" style="text-align: center;"><?php echo $category[$fet_que['space']];?></h3>
          ...
          <div class="column2" >
            ...
            <div class="column3" style="color:green;" id="vote_<?php echo $fet_que['qid'];?>" onclick="vote('<?php echo $fet_que['qid'];?>')">Upvote (<b id="vote_dis_<?php echo $fet_que['qid'];?>"><?php echo $vote_cnt;?></b>)</div>
          <?php }else{?>
